...
const modulePathConfig = {
  ...
  modules: [
    ...
    ['coreRuntime', 'core/coreRuntime.js'],
    ['nativeBindings', 'core/nativeBindings.js'],
    ['databaseApi', 'core/databaseApi.js'],
    ['villageState', 'core/villageState.js'],
    ['packetApi', 'api/packetApi.js'],
    ['gameApi', 'api/gameApi.js'],
    ['villageAttack', 'features/villageAttack.js'],
    ['questFeature', 'features/questFeature.js'],
    ['towerOfDespair', 'features/towerOfDespair.js'],
    ['avatarEmblem', 'features/avatarEmblem.js'],
    ['ranking', 'features/ranking.js'],
    ['dropRate', 'features/dropRate.js'],
    ['gmBypass', 'features/gmBypass.js'],
    ['itemSearch', 'commands/itemSearch.js'],
    ['gmCommands', 'commands/gmCommands.js'],
    ['dungeonPatch', 'features/dungeonPatch.js'],
    ['utilityPatches', 'features/utilityPatches.js'],
    ['userWorld', 'features/userWorld.js'],
    ['returnUser', 'features/returnUser.js'],
    ['hiddenOption', 'features/hiddenOption.js'],
    ['main', 'main.js'],
